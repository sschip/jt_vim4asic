...
ctags_gen: $(CTAGS_SOURCE)
	@mkdir -p $(OUTPUT_DIR)
	@echo "$(ctags_exec) $(CTAGS_OPTION) -f $(OUTPUT_DIR)/$(TAGS_FILE_NAME) $(CTAGS_KINDS) $(CTAGS_INPUT)"
	@$(ctags_exec) $(CTAGS_OPTION) -f $(OUTPUT_DIR)/$(TAGS_FILE_NAME) $(CTAGS_KINDS) $(CTAGS_INPUT)
...
ctags_gen_reference: $(CTAGS_SOURCE)
	@mkdir -p $(OUTPUT_DIR)
	@echo "$(ctags_exec) $(CTAGS_OPTION_REFERENCE) -f $(OUTPUT_DIR)/$(TAGS_REFERENCE_FILE_NAME) $(CTAGS_KINDS_REFERENCE) $(CTAGS_INPUT)"
	@$(ctags_exec) $(CTAGS_OPTION_REFERENCE) -f $(OUTPUT_DIR)/$(TAGS_REFERENCE_FILE_NAME) $(CTAGS_KINDS_REFERENCE) $(CTAGS_INPUT)
